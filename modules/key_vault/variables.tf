...
variable "existing_vnet_id" {
  description = "The resource id of existing Virtual network"
  default     = null
  type        = string
}
...
variable "enable_storage_encryption" {
  description = "Enable storage encryption key creation"
  type        = bool
  default     = false
}

variable "enable_certificate" {
  description = "Enable certificate creation in Key Vault"
  type        = bool
  default     = false
}

variable "enable_mssql_encryption" {
  description = "Enable SQL Server encryption key creation"
  type        = bool
  default     = false
}

variable "enable_disk_encryption" {
  description = "Enable Disk Encryption Key creation"
  type        = bool
  default     = false
}
