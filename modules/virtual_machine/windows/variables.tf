...
variable "bypass_platform_safety_checks_on_user_schedule_enabled" {
  description = "Specifies if bypass_platform_safety_checks_on_user_schedule_enabled for the Windows Virtual Machine."
  default     = true
}

variable "patch_assessment_mode" {
  description = "Specifies patch_assessment_mode for the Windows Virtual Machine."
  default     =  "AutomaticByPlatform" #"ImageDefault"
}
...
variable "use_spot_instance" {
  description = "Set to true to use Spot Instances, false for On-Demand Instances"
  type        = bool
  default     = false
}

variable "eviction_policy" {
  description = "Eviction policy for Spot Instances. Options are 'Deallocate' or 'Delete'."
  type        = string
  default     = "Deallocate"
}
...
variable "os_disk" {
  ...
  type = object({
    name                             = string
    caching                          = string
    enable_os_disk_write_accelerator = bool
...
variable "boot_diagnostics_storage_uri" {
  description = "The URI of the storage account where boot diagnostics logs will be stored."
  type        = string
  default     = null # Set to null to allow flexibility, it can be provided via .tfvars
}
