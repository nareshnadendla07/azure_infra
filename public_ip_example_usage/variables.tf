...
variable "public_ip_prefix_resource_id" {
  description = "Resource ID of the Public IP Prefix object. This is only needed if you want your Public IPs created in a PIP Prefix."
  type        = string
  default     = null
}
